...
import { BookOpen, CheckCircle2, ChevronDown, ChevronUp, Settings, Map, FileText, AlertTriangle, ClipboardCheck, ScrollText } from 'lucide-react';
...
const STEPS = [
  {
    ...
    why: 'The app needs to know which standards apply to your site — BRCGS for food and packaging, or ISO 9001 / 14001 / 45001 — so it can load the correct set of clauses to map against.',
    what: 'Go to Compliance Settings and select your standard(s) — e.g. BRCGS Packaging Issue 7 or ISO 9001:2015. Also enter your target certification audit date — this will show a countdown on the dashboard.',
    href: '/brc/settings',
    cta: 'Go to Compliance Settings',
  ...
  },
  {
    ...
    why: 'Every clause of the standard must be assessed against your site\'s compliance. This gives the auditor confidence that you have reviewed every requirement.',
  ...
  },
  {
    ...
    what: 'On each clause detail page, click "Add Evidence" to link existing records from your registers (Documents, Audits, Calibration, Suppliers, etc.). You can also link to clauses from within each register using the "Link to Clause" button on any record.',
    href: '/brc/clauses',
  ...
  },
  {
    ...
    why: 'An internal audit before the certification audit identifies any remaining gaps and demonstrates a working audit programme — itself a requirement of every audit standard.',
...
const GLOSSARY = [
  { term: 'Clause', def: 'A specific requirement in your standard. Each clause must be complied with and evidenced during the audit.' },
  ...
  { term: 'Non-Conformance (NC)', def: 'A failure to meet a requirement of the standard. NCs are classified as Observation, Minor, Major, or Critical. Under BRCGS, a Major NC against a fundamental clause fails the audit.' },
  ...
  { term: 'Evidence Link', def: 'A connection from a record (document, audit finding, etc.) to the clause it provides evidence for. Use the Add Evidence button on any clause.' },
    ...
    <div className="space-y-8 max-w-3xl">
      <div>
        <h1 className="text-2xl font-bold font-jakarta text-foreground flex items-center gap-2">
          <BookOpen className="w-6 h-6 text-primary" /> Audit Preparation Guide
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          A step-by-step walkthrough of how to use this app to prepare for your certification audit — BRCGS or ISO. Work through the 6 stages in order — each stage builds on the last.
        </p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="px-5 py-3.5 border-b border-border bg-muted/30">
          <h2 className="text-sm font-semibold text-foreground">Terminology Guide</h2>
